export default function( server ) {
	...
	var team1 = server.create('team', { user_id: rob.id });
	var team2 = server.create('team', { user_id: doug.id });

	server.createList('golfer', 5, { team_id: team1.id } );
	server.createList('golfer', 5, { team_id: team2.id } );
